...
// Inline composer (no modal) for messaging every registered team of a tournament.
const MessageTab = ({ tournamentId }) => {
  ...
  const target = { type: BROADCAST_TARGET.TOURNAMENT, ids: [tournamentId] };
  ...
  return (
    ...
    >
      <p className="text-sm text-muted-foreground">
        Xabar turnirga ro'yxatdan o'tgan barcha komandalarning sardori va a'zolariga
